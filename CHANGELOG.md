...
Аудит всего репозитория (68 находок, раздел «Bug audit» в отчёте
`BUGSAUDIT-2026-09-19.md`). Ниже — то, что видно пользователю.
...
- `BUGSAUDIT-2026-09-19.md` — отчёт аудита: покрытие, 68 находок, журнал решений и правок с проверками.

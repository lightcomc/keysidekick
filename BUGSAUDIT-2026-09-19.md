...
Итоги: подтверждено 59 · гипотез 6 · областей закрыто 8 из 9 (не закрыта `keyboard-binding/` как не-продукт).
Правками закрыто: P0 — 1/1, P1 — 25 из 32, P2 — 7 из 26; остальное перечислено в §6 поимённо.

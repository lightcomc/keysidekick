...
Итоги: находок 62 · полностью подтверждено 60 · содержат непроверенную часть 2 (BA-26 — какие именно процессы не дают прочитать имя; BA-27 — переиспользование HWND ОС) · областей закрыто 8 из 9 (не закрыта `keyboard-binding/` как не-продукт).
Правками закрыто: P0 — 1/1, P1 — 27 из 33, P2 — 9 из 28; остальное перечислено в §6 поимённо.

...
Итоги: находок 59 · полностью подтверждено 57 · содержат непроверенную часть 2 (BA-26 — какие именно процессы не дают прочитать имя; BA-27 — переиспользование HWND ОС) · областей закрыто 8 из 9 (не закрыта `keyboard-binding/` как не-продукт).
